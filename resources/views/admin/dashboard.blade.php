                ...
                <div class="row g-3 my-2">
                    <div class="col-md-6">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2 text-center">{{$countpost}}</h3>
                    ...
                    <div class="col-md-6">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2 text-center">{{$totalcomments}}</h3>
                                <p class="fs-5">Total Comments</p>
                            </div>
                            <i
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">{{++$key}}</th>
                                    <td>{{$post->posting_description}}</td>
                                    <td>{{$post->post_date}}</td>
                                    <td><a href="{{url('editpost/'.$post->id)}}">EDIT</a> &nbsp;&nbsp; <a href="{{url('deleteitem/'.$post->id)}}">DELETE </a> </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
